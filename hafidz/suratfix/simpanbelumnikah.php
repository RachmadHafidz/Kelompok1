...
// Proses upload
	...
	$query = "INSERT INTO sk_belumnikah VALUES('".$NO_DOMISILI."','".$NIK_PENDUDUK."', '".$TGLSURATJU."','".$NAMAAJU."','".$JKAJU."','".$AGAMAAJU."','".$NIKPENGAJU."','".$TMPLHRAJU."','".$TGLHRAJU."','".$PEKERJAAN_AJU."','".$ALAMATAJU."','".$KETRANGANAJU."','".$TUJUANJU."','".$JENIS_SURATAJU."')";
	...
	if($sql){ // Cek jika proses simpan ke database sukses atau tidak
		...
		echo "<br><a href=http://localhost/Kelompok1/hafidz/suratfix/formbelumnikah.php>Kembali Ke Form</a>";
	}
