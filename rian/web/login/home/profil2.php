...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index2.php">S.I.I SABRANG</a>
...
<?php } ?>
        ...
        <div class="card mb-3">
          ...
          echo "<center>
                ...
                echo "
                <hr>
                <a href='profil2.php?aksi=update&ID_ADMIN=".$data['ID_ADMIN']."'><input type='button' value='Ubah Password'></a>";
           ?>
    ...
    if(isset($_POST['btn_ubah'])){
     ...
     if(isset($_GET['ID_ADMIN'])){?>
        ...
        <div class="card mb-3">
          ...
          <a href="profil2.php"><input type="button" value="Batal"></a>
          <hr>
