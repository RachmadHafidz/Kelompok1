...
function hapus_data($koneksi){
 if(isset($_GET['NIK_PENDUDUK']) && isset($_GET['aksi'])){
    ...
    if($sql2){
      if($_GET['aksi'] == 'delete'){
        header('location:pdpenduduk3.php');
      }else{
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index3.php">S.I.D SABRANG</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow active">
        ...
        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <li> <a class="dropdown-item" href="profil3.php">Profil</a></li>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown active">
        ...
        <h6 class="dropdown-header">Data:</h6>
          <a class="dropdown-item" href="pdpenduduk3.php">Data Penduduk</a>
          <a class="dropdown-item" href="pdkeluarga3.php">Data Keluarga</a>
        </div>
      </li>
...
?>
        ...
        <div class="card mb-3">
          ...
          <?php
            ...
            <a href="pdpenduduk3.php"><input type="button" value="Batal"></a>
            <hr>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
          <form method="post" action="" enctype="multipart/form-data">
          <a href="pdpenduduk3.php"><input type="button" value="Tambah Data"></a>
          <hr>
            <table cellpadding="8">
            <tr>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                  ...
                  while ($row=mysqli_fetch_array($sql)){
                    ...
                    echo "<td><a class='fas fa-few fa-ban' href='pdpenduduk3.php?aksi=status&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'> </a>
                              <a class='fas fa-few fa-edit' href='pdpenduduk3.php?aksi=update&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'></a> 
                              <a class='fas fa-few fa-trash' href='pdpenduduk3.php?aksi=delete&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'></a></td>";
                    echo "</tr>";
                  }
                  ?> 
                </tbody>
