...
$nosur=$_GET['nosur'];
$nik=$_SESSION['nik/id'];
$query2 = "SELECT * FROM sk_belumnikah INNER JOIN penduduk ON sk_belumnikah.NO_BNIKAH='$nosur' AND sk_belumnikah.NIK_PENDUDUK=penduduk.NIK_PENDUDUK JOIN keluarga ON penduduk.NO_KK=keluarga.NO_KK and penduduk.NIK_PENDUDUK='$nik'";
