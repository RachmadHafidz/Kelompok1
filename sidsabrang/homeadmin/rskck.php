...
$nosur=$_GET['nosur'];
$nik= $_GET['nik'];
$query2 = "SELECT * FROM sk_skck inner join penduduk ON sk_skck.NIK_AJU='".$nik."' and sk_skck.NIK_PENDUDUK=penduduk.NIK_PENDUDUK and sk_skck.NO_SKCK='".$nosur."'  join keluarga on penduduk.NO_KK=keluarga.NO_KK ";
