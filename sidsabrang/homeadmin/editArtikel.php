      ...
      <div class="container-fluid">
		...
		<form action="prosesubahart.php?id=<?=$row['ID_ARTIKEL']?>" method="post" enctype="multipart/form-data">
			...
			<div class="kotak">
				...
				<input type="file" name="foto" class="form-control" value="<?= $row['FOTO_ARTIKEL'] ?>">
			</div>
      <div class="kotak">
				<label>Kategori</label>
        <select type="text" name="kategori" class="form-control" value="<?= $row['ID_KATEGORI'] ?>">
                            <option><?= $row['ID_KATEGORI'] ?></option>
                            <?php  include 'koneksi.php';
                            $data = mysqli_query($koneksi, "select * from kategori");
                            while ($hasil = mysqli_fetch_array($data)) {
                            $nokk= $hasil['ID_KATEGORI']; 
                            ?> <option><?=$nokk?></option>
                            <?php } ?>
        </select>                  
			</div>
