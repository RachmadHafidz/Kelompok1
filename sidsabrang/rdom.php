...
$nosur=$_GET['nosur'];
$nik= $_GET['nik'];
$query2 = "SELECT * FROM sk_domisili inner join penduduk ON sk_domisili.NIKAJU='".$nik."' and sk_domisili.NIKAJU=penduduk.NIK_PENDUDUK and sk_domisili.NO_DOMISILI='".$nosur."'  join keluarga on penduduk.NO_KK=keluarga.NO_KK ";
            $sql2 = mysqli_query($koneksi, $query2);  // Eksekusi/Jalankan query dari variabel $query
            $dataa = mysqli_fetch_array($sql2);

$NO_DOMISILI = $dataa['NO_DOMISILI'];
$TGLSURATJU = $dataa['TGLSURATAJU'];
$BERLAKU = $dataa['BERLAKU'];
$NAMAAJU = $dataa['NAMAAJU'];
$JKAJU = $dataa['JKAJU'];
$AGAMAAJU = $dataa['AGAMAAJU'];
$NIKPENGAJU = $dataa['NIKAJU'];
$TMPLHRAJU = $dataa['TMPLHRAJU'];
$TGLHRAJU = $dataa['TGLHRAJU'];
$STATUSAJU = $dataa['STATUSAJU'];
$PEKERJAANAJU = $dataa['PEKERJAANAJU'];
$ALAMATAJU = $dataa['ALAMATAJU'];
$KWNAJU = $dataa['KWNAJU'];
$TUJUANJU = $dataa['TUJUANAJU'];
...
<tr>
	...
	<tr>
      <td colspan="2"><div align="center">Nomor : 474 /<?php echo $NO_DOMISILI;?>/35.09.12.2002/<?php echo $year;?></div></td>
    </tr>					
	<tr>
      <td colspan="2">&nbsp;</td>
    </tr>
