...
$nosur=$_GET['nosur'];
$nik=$_SESSION['nik/id'];
$query2 = "SELECT * FROM sk_domisili INNER JOIN penduduk ON sk_domisili.NO_DOMISILI='$nosur' AND sk_domisili.NIK_PENDUDUK=penduduk.NIK_PENDUDUK JOIN keluarga ON penduduk.NO_KK=keluarga.NO_KK and penduduk.NIK_PENDUDUK='$nik'";
