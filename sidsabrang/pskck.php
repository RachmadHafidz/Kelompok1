                ...
                <div class="col-12 col-lg-12">
                    <div class="single-blog-area clearfix mb-50">
                        ...
                        <div class="single-blog-content" align="center">
                            <div class="line"></div>
                            <h4><a href="#" class="post-headline">Status Surat SKCK</a></h4>
                            <p class="mb-3">
                                    <!-- Widget Area -->
                                <div class="sidebar-widget-area">
                                    <form action="pskck.php" class="search-form">
                                ...
                                if(isset($_GET['search'])){
                                    $cari=$_GET['search'];
                                    $query1 = "SELECT * FROM sk_skck where NO_SKCK like '%".$cari."%' or KETERANGAN_AJU like '%".$cari."%'"; // Query untuk menampilkan semua data siswa
                            ...
                            <table class="table table-bordered" id="dataTable" border="1" width="100%" >
                                    ...
                                    if(isset($_GET['search'])){
                                        $cari=$_GET['search'];
                                        $query = "SELECT * FROM sk_skck where NO_SKCK like '%".$cari."%' or KETERANGAN_AJU like '%".$cari."%'";
