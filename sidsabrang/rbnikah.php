...
$nosur=$_GET['nosur'];
$nik= $_GET['nik'];
$query2 = "SELECT * FROM sk_belumnikah inner join penduduk ON sk_belumnikah.NIKBN='".$nik."' and sk_belumnikah.NIKBN=penduduk.NIK_PENDUDUK and sk_belumnikah.NO_BNIKAH='".$nosur."'  join keluarga on penduduk.NO_KK=keluarga.NO_KK ";
            $sql2 = mysqli_query($koneksi, $query2);  // Eksekusi/Jalankan query dari variabel $query
            $dataa = mysqli_fetch_array($sql2);

$NO_BNIKAH = $dataa['NO_BNIKAH'];
$TGLSURATJU = $dataa['TGLSURATBN'];
$BERLAKU = $dataa['BERLAKUBN'];
$NAMAAJU = $dataa['NAMABN'];
$JKAJU = $dataa['JKBN'];
$AGAMAAJU = $dataa['AGAMABN'];
$NIKPENGAJU = $dataa['NIKBN'];
$TMPLHRAJU = $dataa['TMPLHRBN'];
$TGLHRAJU = $dataa['TGLHRBN'];
$PEKERJAANAJU = $dataa['PEKERJAANBN'];
$ALAMATAJU = $dataa['ALAMATBN'];
$KWNAJU = $dataa['KWNBN'];
$TUJUANJU = $dataa['TUJUANBN'];
...
<tr>
	...
	<tr>
      <td colspan="2"><div align="center"><strong><u>SURAT KETERANGAN BELUM MENIKAH</u></strong></div></td>
    </tr>
	<tr>
      <td colspan="2"><div align="center">Nomor : 474 /<?php echo $NO_BNIKAH;?>/35.09.12.2002/<?php echo $year;?></div></td>
    </tr>					
	<tr>
      <td colspan="2">&nbsp;</td>
    </tr>
