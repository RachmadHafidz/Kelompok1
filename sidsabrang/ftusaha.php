...
<tr>
	...
	<tr>
      <td colspan="2"><div align="center">Nomor : 474 /<input readonly type="text" name="NO_TUSAHA" value="<?php echo $nosurat;?>">/35.09.12.2002/<?php echo $year;?></div></td>
    </tr>					
	<tr>
      <td colspan="2">&nbsp;</td>
    </tr>
...
<table width="50%" border="0" align="center" cellspacing="0" cellpadding="2">
    ...
    <tr>
      ...
      <td>&nbsp;:&nbsp;<input type="text" name="STATUSAJU" id="STATUSAJU" readonly>
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
