      ...
      <nav class="navbar navbar-dark bg-dark justify-content-between"> 
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="visimisi.login.php">Visi & Misi</a>
                ...
                <div class="col-md-15 mb-3">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="text-mono text-center">PETUNJUK</h4>
                    </div>
                            <p>1. Login terlebih dahulu</p>
                            <p>2. Pilihlah menu pelayanan sesuai yang dibutuhkan</p>
                            <p>2. Isilah form dengan data yang benar</p>
                            <p>3. Setelah semua form terisi pilih tombol kirim untuk mengirimkan data kepada kepala desa</p>
                            <p>4. Setelah data terkirim pilih tombol cetak untuk mencetak form</p>
                            <p>5. Bawalah form yang telah di cetak ke kantor kepala desa</p>
