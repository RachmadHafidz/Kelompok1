...
<div class="container">
            ...
            <form class="form-horizontal" role="form" method= "post" action="simpansuratusaha1.php">
            ...
            $no_surat1 = $char . sprintf ("%05s", $nourut); ?>
                ...
                <div class="form-group">
                    <label for="TUJUAN" class="col-sm-3 control-label"> JN Surat</label>
                    <div class="col-sm-9">
                        <input type="text" method= "get" placeholder="TUJUAN" class="form-control" name= "JNSURAT">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" method= "get" placeholder="TUJUAN" class="form-control" name= "ARSIP">
                    </div>
                </div>
