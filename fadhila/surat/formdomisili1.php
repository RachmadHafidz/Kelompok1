...
<div class="container">
            ...
            <form class="form-horizontal" role="form" method= "post" action="simpandomisili1.php">
            ...
            $no_surat1 = $char . sprintf ("%05s", $nourut); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" method= "get" placeholder="KETERANGAN" class="form-control" name= "JENIS_SURATAJU">
                    </div>
                </div>
