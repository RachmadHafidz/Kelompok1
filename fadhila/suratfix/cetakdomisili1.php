...
$a = $_GET ['nosur'];
$query = "SELECT penduduk.NIK_PENDUDUK, penduduk.NAMAPEN, penduduk.TEMPATLHR, penduduk.TANGGALHR, penduduk.JK_PEN, penduduk.STATUSPEN, penduduk.AGAMAPEN, penduduk.PEKERJAANPEN, penduduk.KWNPEN, keluarga.ALAMAT, keluarga.RT_RW, sk_domisili.TUJUANAJU FROM penduduk, keluarga, sk_domisili WHERE sk_domisili.NIK_PENDUDUK = '$nik' and sk_domisili.NO_DOMISILI = '$a'"; // Query untuk menampilkan semua data siswa
