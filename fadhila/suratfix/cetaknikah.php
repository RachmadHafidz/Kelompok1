	...
	<div id="wrap">
  	<div class="row">
 		...
 		<div class="col-6" align="center">
				...
				<tbody>
				<center>
				<tr><td>Nama</td><td>:</td><td><?php echo $data['NAMAPEN'];?></td></tr>
				<tr><td>NIK</td><td>:</td><td><?php echo $data['TEMPATLHR'];?>,<?php echo $data['TANGGALHR'];?></td></tr>
				<tr><td>Jabatan</td><td>:</td><td> <?php echo $data['JK_PEN']; ?></td></tr>
				</center>
				</tbody></table>
