...
<div class="container">
            ...
            <form class="form-horizontal" role="form" method= "post" >
                ...
                <div class="form-group">
                    <label for="No_kk" class="col-sm-3 control-label"> NO Domisili</label>
                    <div class="col-sm-9">
                        <input type="number" readonly value="<?php echo $data['NO_DOMISILI']; ?>" placeholder="NIK" class="form-control" name = "NO_KK">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">  
                        <input type="text" readonly  value="<?php echo $data['TGLSURATAJU']; ?>"  placeholder="Nama" class="form-control" name= "NAMAPENDUDUK" >
                    </div>
                </div>
                ...
                <a href="http://localhost/Kelompok1/rian/selasa/nyoba2.php"><input class="btn btn-primary btn-block" type="button" value="History Surat"></a>
