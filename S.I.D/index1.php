				...
				<form action="cek_login1.php" method="post">
					<div class="field-group">
						...
						<div class="wthree-field">
							<input name="NIK_PENDUDUK" id="text1" type="text" value="" placeholder="NIK" required>
						</div>
					</div>
					<div class="field-group">
                    ...
                    <div class="wthree-field">
						<button type="button" class="btn"><a href="http://localhost/Kelompok1/S.I.D/nyoba.html">Beranda</a></button>
					</div>
