...
function hapus_data($koneksi){
 if(isset($_GET['NIK_PENDUDUK']) && isset($_GET['aksi'])){
    ...
    if($sql2){
      if($_GET['aksi'] == 'delete'){
        header('location:pdpenduduk2.php');
      }else{
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index2.php">S.I.D SABRANG</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      ...
      <li class="nav-item dropdown no-arrow active">
        ...
        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <li> <a class="dropdown-item" href="profil2.php">Profil</a></li>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown active">
        ...
        <h6 class="dropdown-header">Data:</h6>
          <a class="dropdown-item" href="pdpenduduk2.php">Data Penduduk</a>
          <a class="dropdown-item" href="pdkeluarga2.php">Data Keluarga</a>
          <a class="dropdown-item" href="pdpdesa2.php">Data Perangkat Desa</a>
        </div>
      </li>
...
function tambah_data($koneksi){
  if (isset($_POST['btn_simpan'])) {
    // Ambil Data yang Dikirim dari Form
        ...
        if(!empty($nik) && !empty($no) && !empty($user) && !empty($pass) && !empty($telp)){
          $query = "INSERT INTO penduduk VALUES('".$nik."', '".$admin."', '".$no."', NOW(), '".$nama."', '".$tmplhr."', '".$tglhr."' ,'".$jk."', '".$agama."', '".$status."', '".$peker."' ,'".$pend."', '".$kwn."', '".$sa."', '".$hidup."' ,'".$user."', '".$pass."', '".$telp."', '".$email."')";
                      $sql = mysqli_query($koneksi, $query); // Eksekusi/ Jalankan query dari variabel $query
...
?>
        ...
        <div class="card mb-3">
          ...
          <form method="post" action="" enctype="multipart/form-data">
            <table cellpadding="8">
            <tr>
            <td>ID ADMIN</td><td><input type="number" name="ADMIN" readonly value="<?php echo $_SESSION['idadmin']; ?>"></td>
            <td>AGAMA</td><td>
                        <select name="AGAMA">
                            <option>Islam</option>
          ...
          <?php
            ...
            <a href="pdpenduduk2.php"><input type="button" value="Batal"></a>
            <hr>
        ...
        function ubah_data($koneksi){
          ...
          if(!empty($nik2) && !empty($no2) && !empty($user2) && !empty($telp2)){
            ...
            $sql_ubah = "UPDATE penduduk SET ID_ADMIN='".$admin2."', NO_KK='".$no2."', NAMAPEN='".$nama2."', AGAMAPEN='".$agama2."', NOTELPEN='".$telp2."', STATUSPEN='".$status2."', EMAILPEN='".$email2."', PENDIDIKANPEN='".$pend2."', PEKERJAANPEN='".$peker2."', USERPEN='".$user2."', TEMPATLHR='".$tmplhr2."', TANGGALHR='".$tglhr2."', KWNPEN='".$kwn2."', JK_PEN='".$jk2."', KET_HIDUP='".$hidup2."' WHERE NIK_PENDUDUK='".$nik2."'";
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
          <form method="post" action="" enctype="multipart/form-data">
          <a href="pdpenduduk2.php"><input type="button" value="Tambah Data"></a>
          <hr>
            <table cellpadding="8">
            <tr>
            <td>ID ADMIN</td><td><input type="number" name="ID_ADMIN" readonly value="<?php echo $_SESSION['idadmin']; ?>"></td>
            <td>AGAMA</td><td>
            ...
            <td>EMAIL</td><td><input type="text" name="EMAILPEN" value="<?php echo $dataa['EMAILPEN']; ?>"></td>
            </tr>
            ...
            <td>USERNAME</td><td><input type="text" name="USERPEN" value="<?php echo $dataa['USERPEN']; ?>"></td>
            </tr>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                  ...
                  while ($row=mysqli_fetch_array($sql)){
                    ...
                    echo "<td>".$row['EMAILPEN']."</td>";
                    echo "<td>".$row['KET_HIDUP']."</td>";
                    echo "<td><a class='fas fa-few fa-ban' href='pdpenduduk2.php?aksi=status&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'> </a>
                              <a class='fas fa-few fa-edit' href='pdpenduduk2.php?aksi=update&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'></a> 
                              <a class='fas fa-few fa-trash' href='pdpenduduk2.php?aksi=delete&NIK_PENDUDUK=".$row['NIK_PENDUDUK']."'></a></td>";
                    echo "</tr>";
                  }
                  ?> 
                </tbody>
